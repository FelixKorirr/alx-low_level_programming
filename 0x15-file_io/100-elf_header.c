...
/**
 * print_magic - func that prints magic numbers of an ELF header.
...
/**
 *  * print_version - func that prints version of an ELF header.
...
/**
 * print_type - func that prints type of an ELF header.
 * @e_type: ELF type.
 * @e_ident: Pointer to an array containing the ELF class.
 */
...
/**
 * main - Displays the information held in the ELF header
